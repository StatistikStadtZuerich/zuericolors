...
palettes <- list(
    ...
    "div9val" = c("#782600", "#CC4309", "#FF720C", "#FFBC88", "#FFFFFF", "#AECBFF", "#6B8EFF", "#3B51FF", "#2F2ABB"),
    "div9ntr" = c("#A30059", "#DB247D", "#FF579E", "#FFA8D0", "#FFFFFF", "#A8DBB1", "#55BC5D", "#1D942E", "#10652A"),
    "div9valgry" = c("#782600", "#CC4309", "#FF720C", "#FFBC88", "#E4E0DF", "#AECBFF", "#6B8EFF", "#3B51FF", "#2F2ABB"),
    "div9ntrgry" = c("#A30059", "#DB247D", "#FF579E", "#FFA8D0", "#E4E0DF", "#A8DBB1", "#55BC5D", "#1D942E", "#10652A")
  )
